...
export default function UpcomingScreen() {
  ...
  const isFirstSession = useFirstSession('upcomingIntroSeen');
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={[styles.headerLabel, { color: colors.textSecondary }]}>{isFirstSession === true ? t('microLabel.upcoming') : getDateRangeLabel(band)}</Text>
        </View>
